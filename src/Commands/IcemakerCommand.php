...
/**
 * Watches for changes in a path and freezes it
 */
class IcemakerCommand extends Command
{
    ...
    protected function configure()
    {
        ...
        $this->setName( 'icemaker' )
            ->setDescription( 'Watches for changes in a directory and triggers a freeze.' )
            ->setDefinition(
                array(
            ...
            ->setHelp(
                <<<EOT
                Watches for changes that need to be frozen

Usage:

<info>freezer icemaker -a /path/to/freeze <env></info>
EOT
            );
    }
    ...
    protected function execute( InputInterface $input, OutputInterface $output )
    {
        ...
        $output->writeln( '<header>Making ice...</header>' );
    }
}