    ...
    protected function configure()
    {
        ...
        $this->setName( 'freeze:db' )->setDescription( 'Freezes a directory to the database.' )->setDefinition(
                array(
                    ...
                    new InputOption(
                        'username', 'u', InputOption::VALUE_OPTIONAL, 'The database user name', $_db['user']
                    ),
                    new InputOption(
...
EOT
    ...
    {
        $_headStyle = new OutputFormatterStyle( 'white', 'green', array('bold') );
        $output->getFormatter()->setStyle( 'header', $_headStyle );
